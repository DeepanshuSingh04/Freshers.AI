...
function DownloadBtn({ docRef, user, setUser }) {
    ...
    return (
        <button onClick={handleDownload} className='flex items-center gap-2 rounded-lg bg-amber hover:bg-amber-soft transition-colors px-3 py-2 text-xs font-semibold text-ink'>
            <FiDownload />
            Download PDF
