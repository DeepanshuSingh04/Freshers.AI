        ...
        <div className='flex items-center justify-between mb-5 md:mb-6'>
          <div className='flex items-center gap-2.5'>
            ...
            >
              ...
              <h2 className='font-display text-lg md:text-xl font-semibold text-[#0A0A0A]'>Hello, {user?.name?.split(" ")[0]} 👋 </h2>
        ...
        initial={{ opacity: 0 }}
          ...
          className="mb-3 md:mb-4">
            ...
            <div className='flex items-center gap-1.5 mt-2.5 mb-1'>
              ...
              <p className='text-black/45 text-[11px] font-medium'>Performance</p>
            </div>

            <h3 className='font-display text-[#0A0A0A] font-semibold text-sm md:text-base mb-3 md:mb-4'>Interview History</h3>
